...
public class AuthzPermissionReferencePermissionNameImpl extends AuthzNamedElementImpl implements AuthzPermissionReferencePermissionName {

  public AuthzPermissionReferencePermissionNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AuthzVisitor visitor) {
    visitor.visitPermissionReferencePermissionName(this);
  }
