...
public class AuthzRelationTypeImpl extends AuthzNamedElementImpl implements AuthzRelationType {

  public AuthzRelationTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement handleElementRename(@NotNull String newName) {
    return AuthzPsiImplUtil.handleElementRename(this, newName);
  }
