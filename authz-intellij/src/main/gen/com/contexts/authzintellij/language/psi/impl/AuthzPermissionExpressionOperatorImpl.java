...
public class AuthzPermissionExpressionOperatorImpl extends ASTWrapperPsiElement implements AuthzPermissionExpressionOperator {

  public AuthzPermissionExpressionOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AuthzVisitor visitor) {
    visitor.visitPermissionExpressionOperator(this);
  }
