...
public class AuthzRelationExpressionOperatorImpl extends ASTWrapperPsiElement implements AuthzRelationExpressionOperator {

  public AuthzRelationExpressionOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AuthzVisitor visitor) {
    visitor.visitRelationExpressionOperator(this);
  }
