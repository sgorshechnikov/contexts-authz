...
public class AuthzRelationDefNameImpl extends AuthzNamedElementImpl implements AuthzRelationDefName {

  public AuthzRelationDefNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AuthzVisitor visitor) {
    visitor.visitRelationDefName(this);
  }
