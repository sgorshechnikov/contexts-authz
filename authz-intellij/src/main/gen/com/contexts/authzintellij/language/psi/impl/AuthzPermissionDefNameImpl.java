...
public class AuthzPermissionDefNameImpl extends AuthzNamedElementImpl implements AuthzPermissionDefName {

  public AuthzPermissionDefNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AuthzVisitor visitor) {
    visitor.visitPermissionDefName(this);
  }
