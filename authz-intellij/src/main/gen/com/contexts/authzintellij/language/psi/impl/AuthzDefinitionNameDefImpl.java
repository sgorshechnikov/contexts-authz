...
public class AuthzDefinitionNameDefImpl extends AuthzNamedElementImpl implements AuthzDefinitionNameDef {

  public AuthzDefinitionNameDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AuthzVisitor visitor) {
    visitor.visitDefinitionNameDef(this);
  }
